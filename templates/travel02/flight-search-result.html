                    ...
                    <ul class="navbar-nav ms-auto navbar-search-link">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a class="dropdown-item" href="flight-search-result.html">Search Result</a></li>
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu" id="flights-links">
                                    ...
                                    <a class="items-list active" href="flight-search-result.html">Search Result</a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Flight Search Result</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
                        ...
                        <div class="col-12 col-md-12 col-lg-12 col-xl-12 content-side">
                            <div class="page-search-form">
                                ...
                                <ul class="nav nav-tabs">
                                    <li class="nav-item"><a class="nav-link active" href="#tab-round-trip" data-bs-toggle="tab">Round Trip</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#tab-one-way" data-bs-toggle="tab">One Way</a></li>
                                </ul>
                                        ...
                                        <form class="pg-search-form">
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-6 col-lg-3 col-xl-3">
                                                    <div class="form-group">
                                                        <label><span><i class="fa fa-users"></i></span>Passengers</label>
                                                        <input type="number" class="form-control" placeholder="Total"/>                                                     </div>
                                                </div><!-- end columns -->
                                            </div><!-- end row -->
