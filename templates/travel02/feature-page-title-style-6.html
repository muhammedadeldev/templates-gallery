...
<html lang="en">
<head>
    <title>Page Title Style 6</title>
    <meta charset="utf-8">
    ...
    <div class="wrapper">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown-submenu active"><a href="#" class="dropdown-toggle dropdown-item" data-bs-toggle="dropdown">Page Title</a>
                                    <ul class="dropdown-menu dropdown-sbm left-sbm">
                                        ...
                                        <li class="active"><a href="feature-page-title-style-6.html" class="dropdown-item">Page Title Style 6</a></li>
                                    </ul>
                                </li>
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu mega-sub-menu" id="features-links">
                                    ...
                                    <div class="collapse sub-menu mega-sub-menu-links" id="page-title-style-links">
                                        ...
                                        <a class="items-list active" href="feature-page-title-style-6.html">Page Title Style 6</a>
                                    </div>
        ...
        <section class="page-cover dashboard">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-title">Page Title Style 6</h1>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item">Page Title Style 6</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
