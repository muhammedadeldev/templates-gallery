...
<body>
    ...
    <div class="wrapper">
                    ...
                    <ul class="navbar-nav ms-auto navbar-search-link">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a class="dropdown-item" href="tour-offers.html">Hot Offers</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
            ...
            <nav id="sidebar" class="sidenav">
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                                ...
                                <a class="items-list active" href="#tours-links" data-bs-toggle="collapse"><span><i class="fa fa-globe link-icon"></i></span>Tours<span><i class="fa fa-chevron-down arrow"></i></span></a>
                                <div class="collapse sub-menu" id="tours-links">
                                    ...
                                    <a class="items-list active" href="tour-offers.html">Hot Offers</a>
                                </div><!-- end sub-menu -->
        ...
        <!--================= PAGE-COVER ===============-->
        <section class="page-cover" id="cover-tour-offers">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-title">Tour Offers</h1>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item">Tour Offers</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
        ...
        <section class="innerpage-wrapper">
            <div id="tour-offers" class="innerpage-section-padding">
                <div class="container">
                    <div class="row">
                            ...
                            <div class="row">
                                    ...
                                    <div class="grid-block main-block t-grid-block">
                                        <div class="main-img t-grid-img">
                                            <a href="tour-detail-left-sidebar.html">
                                                <img src="images/tour-grid-1.jpg" class="img-fluid" alt="tour-img" />
                                                <div class="offer-tag">
                                                    <span>12% Off</span>
                                                </div><!-- end offer-tag -->
                                            </a>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="grid-block main-block t-grid-block">
                                        <div class="main-img t-grid-img">
                                            <a href="tour-detail-left-sidebar.html">
                                                <img src="images/tour-grid-2.jpg" class="img-fluid" alt="tour-img" />
                                                <div class="offer-tag">
                                                    <span>12% Off</span>
                                                </div><!-- end offer-tag -->
                                            </a>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="grid-block main-block t-grid-block">
                                        <div class="main-img t-grid-img">
                                            <a href="tour-detail-left-sidebar.html">
                                                <img src="images/tour-grid-3.jpg" class="img-fluid" alt="tour-img" />
                                                <div class="offer-tag">
                                                    <span>12% Off</span>
                                                </div><!-- end offer-tag -->
                                            </a>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="grid-block main-block t-grid-block">
                                        <div class="main-img t-grid-img">
                                            <a href="tour-detail-left-sidebar.html">
                                                <img src="images/tour-grid-4.jpg" class="img-fluid" alt="tour-img" />
                                                <div class="offer-tag">
                                                    <span>12% Off</span>
                                                </div><!-- end offer-tag -->
                                            </a>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="grid-block main-block t-grid-block">
                                        <div class="main-img t-grid-img">
                                            <a href="tour-detail-left-sidebar.html">
                                                <img src="images/tour-grid-5.jpg" class="img-fluid" alt="tour-img" />
                                                <div class="offer-tag">
                                                    <span>12% Off</span>
                                                </div><!-- end offer-tag -->
                                            </a>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="grid-block main-block t-grid-block">
                                        <div class="main-img t-grid-img">
                                            <a href="tour-detail-left-sidebar.html">
                                                <img src="images/tour-grid-6.jpg" class="img-fluid" alt="tour-img" />
                                                <div class="offer-tag">
                                                    <span>12% Off</span>
                                                </div><!-- end offer-tag -->
                                            </a>
