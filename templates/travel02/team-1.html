    ...
    <div class="wrapper">
                                    ...
                                    <div class="row">
                                        <div class="col-md">
                                            <ul class="list-unstyled">
                                                ...
                                                <li class="active"><a href="team-1.html">Our Team 1</a></li>
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu" id="pages-links">
                                    ...
                                    <a class="items-list active" href="team-1.html">Our Team 1</a>
        ...
        <section class="page-cover" id="cover-team">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-title">Our Team 1</h1>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item">Our Team 1</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                                    <div class="member-block text-center">
                                        <div class="member-img">
                                            <img src="images/team-member-6.jpg" class="img-fluid rounded-circle" alt="member-img" />                                 
                                            <ul class="list-unstyled list-inline contact-links">
                                                <li class="list-inline-item"><a href="#"><span><i class="fa fa-facebook-square"></i></span></a></li>
                                                <li class="list-inline-item"><a href="#"><span><i class="fa fa-twitter-square"></i></span></a></li>
                                                <li class="list-inline-item"><a href="#"><span><i class="fa fa-linkedin-square"></i></span></a></li>
                                ...
                                <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                                    <div class="member-block text-center">
                                        <div class="member-img">
                                            <img src="images/team-member-7.jpg" class="img-fluid rounded-circle" alt="member-img" />                                 
                                            <ul class="list-unstyled list-inline contact-links">
                                                <li class="list-inline-item"><a href="#"><span><i class="fa fa-facebook-square"></i></span></a></li>
                                                <li class="list-inline-item"><a href="#"><span><i class="fa fa-twitter-square"></i></span></a></li>
                                                <li class="list-inline-item"><a href="#"><span><i class="fa fa-linkedin-square"></i></span></a></li>
                                ...
                                <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                                    <div class="member-block text-center">
                                        <div class="member-img">
                                            <img src="images/team-member-8.jpg" class="img-fluid rounded-circle" alt="member-img" />                                 
                                            <ul class="list-unstyled list-inline contact-links">
                                                <li class="list-inline-item"><a href="#"><span><i class="fa fa-facebook-square"></i></span></a></li>
                                                <li class="list-inline-item"><a href="#"><span><i class="fa fa-twitter-square"></i></span></a></li>
                                                <li class="list-inline-item"><a href="#"><span><i class="fa fa-linkedin-square"></i></span></a></li>
