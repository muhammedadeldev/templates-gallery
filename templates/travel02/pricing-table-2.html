...
<body>
    ...
    <div class="wrapper">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md">
                                            <ul class="list-unstyled">
                                                ...
                                                <li class="active"><a href="pricing-table-2.html">Pricing Table 2</a></li>
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu" id="pages-links">
                                    ...
                                    <a class="items-list active" href="pricing-table-2.html">Pricing Table 2</a>
        ...
        <!--================= PAGE-COVER ===============-->
        <section class="page-cover" id="cover-price-table">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-title">Pricing Table 2</h1>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item">Pricing Table 2</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
        ...
        <section class="innerpage-wrapper">
            <div id="pricing-table-page" class="innerpage-section-padding pricing-table-2">
                <div class="container">
                    <div class="row">
