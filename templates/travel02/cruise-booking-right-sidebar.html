...
<html lang="en">
    <head>
        <title>Cruise Booking Right Sidebar</title>
        <meta charset="utf-8">
    ...
    <div class="wrapper">
                    ...
                    <ul class="navbar-nav ms-auto navbar-search-link">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a class="dropdown-item" href="cruise-booking-right-sidebar.html">Booking Right Sidebar</a></li>
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu" id="cruise-links">
                                    ...
                                    <a class="items-list active" href="cruise-booking-right-sidebar.html">Booking Right Sidebar</a>
        ...
        <!--=================== PAGE-COVER ================-->
        <section class="page-cover" id="cover-cruise-booking">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-title">Cruise Booking Right Sidebar</h1>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item">Cruise Booking Right Sidebar</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
                                ...
                                <div class="col-12 col-md-6 col-lg-12">
                                    <div class="side-bar-block detail-block style2 text-center">
                                        <div class="detail-img text-center">
                                            <a href="#"><img src="images/cruise-grid-1.jpg" class="img-fluid" alt="detail-img"/></a>
                                            <div class="detail-title">
                                                <h4><a href="#">Belgium to Greek </a></h4>
                                                <p>6 Nights, 7 Days</p>
                                            </div><!-- end detail-title -->
                                            
                                            <span class="detail-price"><h4>$568 <span>/ person</span></h4></span>
                                        </div><!-- end detail-img -->
