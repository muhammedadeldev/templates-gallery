...
<html lang="en">
    <head>
        <title>Cruise Listing Left Sidebar</title>
        <meta charset="utf-8">
...
<div class="wrapper">
            ...
            <div class="collapse navbar-collapse" id="myNavbar1">
                <ul class="navbar-nav ms-auto navbar-search-link">
                    ...
                    <li class="nav-item dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="cruise-homepage.html">Cruise Homepage</a></li>
                            <li class="active"><a class="dropdown-item" href="cruise-listing-left-sidebar.html">List View Left Sidebar</a></li>
            ...
            <div id="main-menu">
                ...
                <div class="list-group panel">
                            ...
                            <div class="collapse sub-menu" id="cruise-links">
                                <a class="items-list" href="cruise-homepage.html">Cruise Homepage</a>
                                <a class="items-list active" href="cruise-listing-left-sidebar.html">List View Left Sidebar</a>
    ...
    <section class="page-cover" id="cover-cruise-grid-list">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-title">Cruise Listing Left Sidebar</h1>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item">Cruise Listing Left Sidebar</li>
                    </ul>
                </div><!-- end columns -->
            </div><!-- end row -->
        </div><!-- end container -->
