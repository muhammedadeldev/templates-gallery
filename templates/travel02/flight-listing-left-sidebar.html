...
<html lang="en">
<head>
    <title>Flight Listing Left Sidebar</title>
    <meta charset="utf-8">
    ...
    <div class="wrapper">
                    ...
                    <ul class="navbar-nav ms-auto navbar-search-link">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="flight-homepage.html">Flight Homepage</a></li>
                                <li class="active"><a class="dropdown-item" href="flight-listing-left-sidebar.html">List View Left Sidebar</a></li>
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu" id="flights-links">
                                    <a class="items-list" href="flight-homepage.html">Flight Homepage</a>
                                    <a class="items-list active" href="flight-listing-left-sidebar.html">List View Left Sidebar</a>
        ...
        <section class="page-cover back-size" id="cover-flight-grid-list">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-title">Flight Listing Left Sidebar</h1>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item">Flight Listing Left Sidebar</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
