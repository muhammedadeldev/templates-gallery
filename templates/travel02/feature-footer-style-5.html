    ...
    <div class="wrapper">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown dropdown-submenu active"><a href="#" class="dropdown-toggle dropdown-item" data-bs-toggle="dropdown">Footer</a>
                                    <ul class="dropdown-menu dropdown-sbm left-sbm">
                                        ...
                                        <li class="active"><a href="feature-footer-style-5.html" class="dropdown-item">Footer Style 5</a></li>
                                    </ul>
                                </li>
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu mega-sub-menu" id="features-links">
                                    ...
                                    <div class="collapse sub-menu mega-sub-menu-links" id="footer-style-links">
                                        ...
                                        <a class="items-list active" href="feature-footer-style-5.html">Footer Style 5</a>
                                    </div>
        ...
        <section class="page-cover back-img">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-title">Footer Style 5</h1>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item">Footer Style 5</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
