...
<body>
    ...
    <div class="wrapper">
                    ...
                    <ul class="navbar-nav ms-auto navbar-search-link">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a class="dropdown-item" href="car-offers.html">Hot Offers</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu" id="cars-links">
                                    ...
                                    <a class="items-list active" href="car-offers.html">Hot Offers</a>
                                </div><!-- end sub-menu -->
        ...
        <!--================ PAGE-COVER ===============-->
        <section class="page-cover" id="cover-car-offers">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-title">Car Offers</h1>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item">Car Offers</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
                            ...
                            <div class="row">
                                    ...
                                    <div class="grid-block main-block cr-grid-block">
                                        <div class="main-img cr-grid-img">
                                            <a href="car-detail-left-sidebar.html">
                                                <img src="images/car-grid-1.jpg" class="img-fluid" alt="car-img" />
                                                <div class="offer-tag">
                                                    <span>12% Off</span>
                                                </div><!-- end offer-tag -->
                                            </a>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="grid-block main-block cr-grid-block">
                                        <div class="main-img cr-grid-img">
                                            <a href="car-detail-left-sidebar.html">
                                                <img src="images/car-grid-2.jpg" class="img-fluid" alt="car-img" />
                                                <div class="offer-tag">
                                                    <span>12% Off</span>
                                                </div><!-- end offer-tag -->
                                            </a>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="grid-block main-block cr-grid-block">
                                        <div class="main-img cr-grid-img">
                                            <a href="car-detail-left-sidebar.html">
                                                <img src="images/car-grid-3.jpg" class="img-fluid" alt="car-img" />
                                                <div class="offer-tag">
                                                    <span>12% Off</span>
                                                </div><!-- end offer-tag -->
                                            </a>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="grid-block main-block cr-grid-block">
                                        <div class="main-img cr-grid-img">
                                            <a href="car-detail-left-sidebar.html">
                                                <img src="images/car-grid-4.jpg" class="img-fluid" alt="car-img" />
                                                <div class="offer-tag">
                                                    <span>12% Off</span>
                                                </div><!-- end offer-tag -->
                                            </a>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="grid-block main-block cr-grid-block">
                                        <div class="main-img cr-grid-img">
                                            <a href="car-detail-left-sidebar.html">
                                                <img src="images/car-grid-5.jpg" class="img-fluid" alt="car-img" />
                                                <div class="offer-tag">
                                                    <span>12% Off</span>
                                                </div><!-- end offer-tag -->
                                            </a>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="grid-block main-block cr-grid-block">
                                        <div class="main-img cr-grid-img">
                                            <a href="car-detail-left-sidebar.html">
                                                <img src="images/car-grid-6.jpg" class="img-fluid" alt="car-img" />
                                                <div class="offer-tag">
                                                    <span>12% Off</span>
                                                </div><!-- end offer-tag -->
                                            </a>
