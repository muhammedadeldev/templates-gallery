...
<body>
    ...
    <div class="wrapper">
                    ...
                    <ul class="navbar-nav ms-auto navbar-search-link">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a class="dropdown-item" href="flight-offers.html">Hot Offers</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu" id="flights-links">
                                    ...
                                    <a class="items-list active" href="flight-offers.html">Hot Offers</a>
                                </div><!-- end sub-menu -->
        ...
        <!--=================== PAGE-COVER ===============-->
        <section class="page-cover" id="cover-flight-offers">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-title">Flight Offers</h1>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item">Flight Offers</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
        ...
        <section class="innerpage-wrapper">
            <div id="flight-offers" class="innerpage-section-padding">
                <div class="container">
                    <div class="row">
