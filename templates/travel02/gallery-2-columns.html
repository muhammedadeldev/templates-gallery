                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown dropdown-submenu active"><a href="#" class="dropdown-toggle dropdown-item" data-bs-toggle="dropdown">Gallery</a>
                                    <ul class="dropdown-menu dropdown-sbm left-sbm">
                                        ...
                                        <li class="active"><a href="gallery-2-columns.html" class="dropdown-item">Gallery 2 Columns</a></li>
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu mega-sub-menu" id="features-links">
                                    ...
                                    <div class="collapse sub-menu mega-sub-menu-links" id="f-gallery-links">
                                        ...
                                        <a class="items-list active" href="gallery-2-columns.html">Gallery 2 Columns</a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Gallery-2-columns</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                            ...
                            <div class="row">
                                    ...
                                    <div class="gallery-product col-12 col-md-6 col-lg-6 col-xl-6">
