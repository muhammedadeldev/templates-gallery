                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu" id="pages-links">
                                    ...
                                    <a class="items-list active" href="about-us-2.html">About Us 2</a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-7 col-lg-7" id="why-us-tabs">
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li class="nav-item">
                                            <a href="#tb-happy-client" data-bs-toggle="tab" class="nav-link active"><span><i class="fa fa-smile-o "></i></span>Happy Clients</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#tb-satisfaction" data-bs-toggle="tab" class="nav-link"><span><i class="fa fa-thumbs-o-up"></i></span>Satisfaction</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#tb-daily-tours" data-bs-toggle="tab" class="nav-link"><span><i class="fa fa-plane"></i></span>Daily Tours</a>
                                        </li>
                                    </ul><!-- end nav-tabs -->
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div id="tb-satisfaction" class="container tab-pane">
                                        ...
                                        <div id="tb-daily-tours" class="container tab-pane">
                                            <p> Lorem ipsum dolor si Iuvaret detraxit disputando velr.Lorem ipsum dolor si. Ad duo fugit aeque fabulas, pro an eros perpetua ullamcorper. Iuvaret detraxit disputando vel ea, ut virtute per.</p>
                                            ...
                                            <div class="row">
                                                <div class="owl-carousel owl-theme" id="owl-company-logo">
                                                    <div class="col px-3">
                                                        <div class="item">
                                                            <div class="company-img">
                                                                <img src="images/company-1.png" class="img-fluid" alt="logo" />
                                                            </div><!-- company-img -->
                                                        </div><!-- item -->
                                                    </div><!-- end columns -->
                                                    ...
                                                    <div class="col px-3">                       
                                                        <div class="item">
                                                            <div class="company-img">
                                                                <img src="images/company-2.png" class="img-fluid" alt="logo" />
                                                            </div><!-- company-img -->
                                                        </div><!-- item -->
                                                    </div><!-- end columns -->
                                                    ...
                                                    <div class="col px-3">
                                                        <div class="item">
                                                            <div class="company-img">
                                                                <img src="images/company-3.png" class="img-fluid" alt="logo" />
                                                            </div><!-- company-img -->
                                                        </div><!-- item -->
                                                    </div><!-- end columns -->
                                                    ...
                                                    <div class="col px-3">
                                                        <div class="item">
                                                            <div class="company-img">
                                                                <img src="images/company-4.png" class="img-fluid" alt="logo" />
                                                            </div><!-- company-img -->
                                                        </div><!-- item -->
                                                    </div><!-- end columns -->
                                                    ...
                                                    <div class="col px-3">
                                                        <div class="item">
                                                            <div class="company-img">
                                                                <img src="images/company-5.png" class="img-fluid" alt="logo" />
                                                            </div><!-- company-img -->
                                                        </div><!-- item -->
                                                    </div><!-- end columns -->
