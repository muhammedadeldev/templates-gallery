...
<html lang="en">
    <head>
        <title>Cruise Search Result</title>
        <meta charset="utf-8">
...
<div class="wrapper">
                ...
                <ul class="navbar-nav ms-auto navbar-search-link">
                    ...
                    <li class="nav-item dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a class="dropdown-item" href="cruise-search-result.html">Search Result</a></li>
            ...
            <div id="main-menu">
                ...
                <div class="list-group panel">
                            ...
                            <div class="collapse sub-menu" id="cruise-links">
                                ...
                                <a class="items-list active" href="cruise-search-result.html">Search Result</a>
    ...
    <!--======================= PAGE-COVER =====================-->
    <section class="page-cover back-size" id="cover-cruise-search">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-title">Cruise Search Result</h1>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item">Cruise Search Result</li>
                    </ul>
                </div><!-- end columns -->
            </div><!-- end row -->
        </div><!-- end container -->
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-12 col-lg-12 col-xl-12 content-side">
                        <div class="page-search-form">
                            <h2>Search the <span>Cruise <i class="fa fa-ship"></i></span></h2>
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6 col-lg-3 col-xl-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Destination, City, Country"/>
                                        </div>
                                    </div><!-- end columns -->
