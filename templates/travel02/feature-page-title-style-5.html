...
<html lang="en">
<head>
    <title>Page Title Style 5</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="wrapper">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown-submenu active"><a href="#" class="dropdown-toggle dropdown-item" data-bs-toggle="dropdown">Page Title</a>
                                    <ul class="dropdown-menu dropdown-sbm left-sbm">
                                        ...
                                        <li class="active"><a href="feature-page-title-style-5.html" class="dropdown-item">Page Title Style 5</a></li>
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu mega-sub-menu" id="features-links">
                                    ...
                                    <div class="collapse sub-menu mega-sub-menu-links" id="page-title-style-links">
                                        ...
                                        <a class="items-list active" href="feature-page-title-style-5.html">Page Title Style 5</a>
        ...
        <!--============= PAGE-COVER =============-->
        <section class="page-cover style style5 p-20">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h1 class="page-title"><span class="pt-icon-left"><i class="fa fa-info-circle"></i></span>Page Title Style 5<span class="pt-icon-right"><i class="fa fa-info-circle"></i></span></h1>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
