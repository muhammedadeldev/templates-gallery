                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md">
                                            <ul class="list-unstyled">
                                                ...
                                                <li class="active"><a href="payment-success.html">Payment Success</a></li>
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu" id="pages-links">
                                    ...
                                    <a class="items-list active" href="payment-success.html">Payment Success</a>
                            ...
                            <div class="payment-success-text">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        <thead>
                                            <tr>
                                                <td><span><i class="fa fa-clone"></i></span>Category</td>
                                                <td><span><i class="fa fa-diamond"></i></span>Item Name</td>
                                                <td><span><i class="fa fa-dollar"></i></span>Item Price</td>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td><span><i class="fa fa-plane"></i></span>Flight</td>
                                                <td>London to Spain<span class="t-date">25-05-2018</span></td>
                                                <td>$550</td>
                                            </tr>
                                            <tr>
                                                <td><span><i class="fa fa-building"></i></span>Hotel</td>
                                                <td>Herta Berlin Hotel<span class="t-date">25-05-2018</span></td>
                                                <td>$150</td>
                                            </tr>
                                        </tbody>
                                    </table>
