                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu" id="pages-links">
                                    ...
                                    <a class="items-list active" href="wishlist.html">Wishlist</a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-2 col-lg-2 dashboard-nav">
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li class="nav-item active"><a class="nav-link" href="#"><span><i class="fa fa-heart"></i></span>Wishlist</a></li>
                                            <li class="nav-item"><a class="nav-link" href="cards.html"><span><i class="fa fa-credit-card"></i></span>My Cards</a></li>
                                        </ul>
                                    </div><!-- end columns-->
                                    
                                    <div class="col-12 col-md-10 col-lg-10 dashboard-content wishlist">
                                        <h2 class="dash-content-title">Your Wish List</h2>
                                                <div class="table-responsive">
                                            <table class="table table-hover">
                                                <tbody>
                                                    <tr class="list-content">
                                                        <td class="list-img wishlist-img d-block"><img src="images/wishlist.jpg" class="img-fluid d-none d-md-block" alt="wishlist-img" /></td>
                                                        <td class="list-text wishlist-text">
                                                            ...
                                                            <button class="btn btn-lightgrey d-none d-md-block d-lg-none pull-right">Remove</button>
                                                        </td>
