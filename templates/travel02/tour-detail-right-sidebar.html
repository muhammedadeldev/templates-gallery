                        ...
                        <div class="col-12 col-md-12 col-lg-9 col-xl-9 content-side">
                            ...
                            <div class="detail-slider">
                                <div class="feature-slider">
                                    <div><img src="images/t-feature-1.jpg" class="img-fluid" alt="feature-img"/></div>
                            ...
                            <div class="detail-tabs">
                                <ul class="nav nav-tabs nav-justified">
                                    <li class="nav-item"><a class="nav-link active" href="#tour-information" data-bs-toggle="tab">Tour Information</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#flight" data-bs-toggle="tab">Flight</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#map-overview" data-bs-toggle="tab">View Map</a></li>
                                </ul>
