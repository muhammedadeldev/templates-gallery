                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown dropdown-submenu active"><a href="#" class="dropdown-toggle dropdown-item" data-bs-toggle="dropdown">Blog</a>
                                        <ul class="dropdown-menu dropdown-sbm left-sbm">
                                            ...
                                            <li class="active"><a href="blog-listing-right-sidebar.html" class="dropdown-item">Blog Listing Right Sidebar</a></li>
                        ...
                        <div class="list-group panel">
                                    ...
                                    <div class="collapse sub-menu mega-sub-menu" id="features-links">
                                        ...
                                        <div class="collapse sub-menu mega-sub-menu-links" id="f-blog-links">
                                            ...
                                            <a class="items-list active" href="blog-listing-right-sidebar.html">Blog Listing Right Sidebar</a>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">Blog Listing Right Sidebar</li>
                            </ul>
                        </div><!-- end columns -->
                    </div><!-- end row -->
                </div><!-- end container -->
                                ...
                                <div class="space-right">
                                    ...
                                    <div class="main-block blog-post blog-list">
                                        ...
                                        <div class="blog-post-detail">
                                            <h2 class="blog-post-title"><a href="blog-detail-right-sidebar.html">The perfect summer destinations</a></h2>
                                        ...
                                        <div class="side-bar-block recent-post">
                                            ...
                                            <div class="recent-block">
                                                <div class="recent-img">
                                                    <a href="blog-detail-right-sidebar.html"><img src="images/recent-post-1.jpg" class="img-fluid" alt="recent-blog-image" /></a>
                                                </div><!-- end recent-img -->
                                            ...
                                            <div class="recent-block">
                                                <div class="recent-img">
                                                    <a href="blog-detail-right-sidebar.html"><img src="images/recent-post-2.jpg" class="img-fluid" alt="recent-blog-image" /></a>
                                                </div><!-- end recent-img -->
                                            ...
                                            <div class="recent-block">
                                                <div class="recent-img">
                                                    <a href="blog-detail-right-sidebar.html"><img src="images/recent-post-3.jpg" class="img-fluid" alt="recent-blog-image" /></a>
                                                </div><!-- end recent-img -->
