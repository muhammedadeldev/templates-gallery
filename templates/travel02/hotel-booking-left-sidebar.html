...
<html lang="en">
<head>
    <title>Hotel Booking Left Sidebar</title>
    <meta charset="utf-8">
    ...
    <div class="wrapper">
                    ...
                    <ul class="navbar-nav ms-auto navbar-search-link">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a class="dropdown-item" href="hotel-booking-left-sidebar.html">Booking Left Sidebar</a></li>
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu" id="hotels-links">
                                    ...
                                    <a class="items-list active" href="hotel-booking-left-sidebar.html">Booking Left Sidebar</a>
        ...
        <section class="page-cover" id="cover-hotel-booking">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-title">Hotel Booking Left Sidebar</h1>
                        <ul class="breadcrumb">
