...
<div class="wrapper">
                ...
                <ul class="navbar-nav ms-auto navbar-search-link">
                    ...
                    <li class="nav-item dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a class="dropdown-item" href="car-detail-left-sidebar.html">Detail Left Sidebar</a></li>
            ...
            <div id="main-menu">
                ...
                <div class="list-group panel">
                            ...
                            <div class="collapse sub-menu" id="cars-links">
                                ...
                                <a class="items-list active" href="car-detail-left-sidebar.html">Detail Left Sidebar</a>
    ...
    <section class="page-cover" id="cover-car-detail">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-title">Car Detail Left Sidebar</h1>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item">Car Detail Left Sidebar</li>
                    </ul>
                </div><!-- end columns -->
            </div><!-- end row -->
        </div><!-- end container -->
                    ...
                    <div class="col-12 col-md-12 col-lg-3 side-bar left-side-bar">
                        ...
                        <div class="side-bar-block booking-form-block">
                            ...
                            <div class="booking-form">
                                ...
                                <form id="frm_car_booking" name="frm_car_booking" method="post">
                                    <div class="form-group">
                    ...
                    <div class="col-12 col-md-12 col-lg-9 col-xl-9 content-side">
                        ...
                        <div class="detail-slider">
                            <div class="feature-slider">
                                <div><img src="images/car-feature-1.jpg" class="img-fluid" alt="feature-img"/></div>
                                <div><img src="images/car-feature-2.jpg" class="img-fluid" alt="feature-img"/></div>
                                <div><img src="images/car-feature-3.jpg" class="img-fluid" alt="feature-img"/></div>
                                <div><img src="images/car-feature-4.jpg" class="img-fluid" alt="feature-img"/></div>
                                <div><img src="images/car-feature-5.jpg" class="img-fluid" alt="feature-img"/></div>
                            </div><!-- end feature-slider -->
                            
                            <div class="feature-slider-nav">
                                <div><img src="images/car-feature-thumb-1.jpg" class="img-fluid" alt="feature-thumb"/></div>
                                <div><img src="images/car-feature-thumb-2.jpg" class="img-fluid" alt="feature-thumb"/></div>
                                <div><img src="images/car-feature-thumb-3.jpg" class="img-fluid" alt="feature-thumb"/></div>
                                <div><img src="images/car-feature-thumb-4.jpg" class="img-fluid" alt="feature-thumb"/></div>
                                <div><img src="images/car-feature-thumb-5.jpg" class="img-fluid" alt="feature-thumb"/></div>
                        ...
                        <div class="detail-tabs">
                            <ul class="nav nav-tabs nav-justified">
                                <li class="nav-item">
                                    <a class="nav-link active" href="#car-information" data-bs-toggle="tab">Car Information</a></li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#cr-features" data-bs-toggle="tab">Features</a></li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#rental-info" data-bs-toggle="tab">Rental Info</a></li>
                            </ul>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="car-information" class="tab-pane in active">
                                    <div class="row">
                                        <div class="col-md-4 col-lg-4 tab-img">
                                            <img src="images/car-detail-tab-1.jpg" class="img-fluid" alt="flight-detail-img" />
                                        </div><!-- end columns -->
                                ...
                                <div id="cr-features" class="tab-pane">
                                    <div class="row">
                                        <div class="col-md-4 col-lg-4 tab-img">
                                            <img src="images/car-detail-tab-2.jpg" class="img-fluid" alt="flight-detail-img" />
                                        </div><!-- end columns -->
                                ...
                                <div id="rental-info" class="tab-pane">
                                    <div class="row">
                                        <div class="col-md-4 col-lg-4 tab-img">
                                            <img src="images/car-detail-tab-3.jpg" class="img-fluid" alt="flight-detail-img" />
                                        </div><!-- end columns -->
                        ...
                        <div class="available-blocks" id="available-cars">
                                ...
                                <div class="list-content">
                                    <div class="main-img list-img cr-list-img">
                                        <a href="car-detail-left-sidebar.html">
                                            <img src="images/car-list-1.jpg" class="img-fluid" alt="car-img" />
                                        </a>
                                        <div class="main-mask">
                                            <ul class="list-unstyled list-inline offer-price-1">
                                                <li class="list-inline-item price">$1250.00<span class="divider">|</span><span class="pkg">7 Days Tour</span></li>
                            ...
                            <div class="list-block main-block cr-list-block">
                                <div class="list-content">
                                    <div class="main-img list-img cr-list-img">
                                        <a href="car-detail-left-sidebar.html">
                                            <img src="images/car-list-2.jpg" class="img-fluid" alt="car-img" />
                                        </a>
                                        <div class="main-mask">
                                            <ul class="list-unstyled list-inline offer-price-1">
                                                <li class="list-inline-item price">$1250.00<span class="divider">|</span><span class="pkg">7 Days Tour</span></li>
                            ...
                            <div class="list-block main-block cr-list-block">
                                <div class="list-content">
                                    <div class="main-img list-img cr-list-img">
                                        <a href="car-detail-left-sidebar.html">
                                            <img src="images/car-list-3.jpg" class="img-fluid" alt="car-img" />
                                        </a>
                                        <div class="main-mask">
                                            <ul class="list-unstyled list-inline offer-price-1">
                                                <li class="list-inline-item price">$1250.00<span class="divider">|</span><span class="pkg">7 Days Tour</span></li>
                            ...
                            <div class="list-block main-block cr-list-block">
                                <div class="list-content">
                                    <div class="main-img list-img cr-list-img">
                                        <a href="car-detail-left-sidebar.html">
                                            <img src="images/car-list-4.jpg" class="img-fluid" alt="car-img" />
                                        </a>
                                        <div class="main-mask">
                                            <ul class="list-unstyled list-inline offer-price-1">
                                                <li class="list-inline-item price">$1250.00<span class="divider">|</span><span class="pkg">7 Days Tour</span></li>
