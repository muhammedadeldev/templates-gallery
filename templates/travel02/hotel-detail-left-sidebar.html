                    ...
                    <ul class="navbar-nav ms-auto navbar-search-link">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a class="dropdown-item" href="hotel-detail-left-sidebar.html">Detail Left Sidebar</a></li>
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu" id="hotels-links">
                                    ...
                                    <a class="items-list active" href="hotel-detail-left-sidebar.html">Detail Left Sidebar</a>
                        ...
                        <div class="col-12 col-md-12 col-lg-9 col-xl-9 content-side">
                            ...
                            <div class="detail-tabs">
                                <ul class="nav nav-tabs nav-justified ">
                                    <li class="nav-item"><a class="nav-link active" href="#hotel-overview" data-bs-toggle="tab">Hotel Overview</a></li>
