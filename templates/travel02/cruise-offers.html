...
<div class="wrapper">
                ...
                <ul class="navbar-nav ms-auto navbar-search-link">
                    ...
                    <li class="nav-item dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a class="dropdown-item" href="cruise-offers.html">Hot Offers</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
            ...
            <div id="main-menu">
                ...
                <div class="list-group panel">
                            ...
                            <div class="collapse sub-menu" id="cruise-links">
                                ...
                                <a class="items-list active" href="cruise-offers.html">Hot Offers</a>
                            </div><!-- end sub-menu -->
    ...
    <!--================== PAGE-COVER ================-->
    <section class="page-cover" id="cover-cruise-offers">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-title">Cruise Offers</h1>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item">Cruise Offers</li>
                    </ul>
                </div><!-- end columns -->
            </div><!-- end row -->
        </div><!-- end container -->
    ...
    <section class="innerpage-wrapper">
        <div id="cruise-offers" class="innerpage-section-padding">
            <div class="container">
                <div class="row">
                        ...
                        <div class="row">
                                ...
                                <div class="grid-block main-block crs-grid-block">
                                    <div class="main-img crs-grid-img">
                                        <a href="cruise-detail-left-sidebar.html">
                                            <img src="images/cruise-grid-1.jpg" class="img-fluid" alt="cruise-img" />
                                            <div class="offer-tag">
                                                <span>12% Off</span>
                                            </div><!-- end offer-tag -->
                                        </a>
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="grid-block main-block crs-grid-block">
                                    <div class="main-img crs-grid-img">
                                        <a href="cruise-detail-left-sidebar.html">
                                            <img src="images/cruise-grid-2.jpg" class="img-fluid" alt="cruise-img" />
                                            <div class="offer-tag">
                                                <span>12% Off</span>
                                            </div><!-- end offer-tag -->
                                        </a>
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="grid-block main-block crs-grid-block">
                                    <div class="main-img crs-grid-img">
                                        <a href="cruise-detail-left-sidebar.html">
                                            <img src="images/cruise-grid-3.jpg" class="img-fluid" alt="cruise-img" />
                                            <div class="offer-tag">
                                                <span>12% Off</span>
                                            </div><!-- end offer-tag -->
                                        </a>
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="grid-block main-block crs-grid-block">
                                    <div class="main-img crs-grid-img">
                                        <a href="cruise-detail-left-sidebar.html">
                                            <img src="images/cruise-grid-4.jpg" class="img-fluid" alt="cruise-img" />
                                            <div class="offer-tag">
                                                <span>12% Off</span>
                                            </div><!-- end offer-tag -->
                                        </a>
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="grid-block main-block crs-grid-block">
                                    <div class="main-img crs-grid-img">
                                        <a href="cruise-detail-left-sidebar.html">
                                            <img src="images/cruise-grid-5.jpg" class="img-fluid" alt="cruise-img" />
                                            <div class="offer-tag">
                                                <span>12% Off</span>
                                            </div><!-- end offer-tag -->
                                        </a>
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="grid-block main-block crs-grid-block">
                                    <div class="main-img crs-grid-img">
                                        <a href="cruise-detail-left-sidebar.html">
                                            <img src="images/cruise-grid-6.jpg" class="img-fluid" alt="cruise-img" />
                                            <div class="offer-tag">
                                                <span>12% Off</span>
                                            </div><!-- end offer-tag -->
                                        </a>
