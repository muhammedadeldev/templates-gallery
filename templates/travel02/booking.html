            ...
            <div id="main-menu">
                ...
                <div class="list-group panel">
                            ...
                            <div class="collapse sub-menu" id="pages-links">
                                ...
                                <a class="items-list active" href="booking.html">Booking</a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-2 col-lg-2 dashboard-nav">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="user-profile.html"><span><i class="fa fa-user"></i></span>Profile</a></li>
                                        <li class="nav-item active">
                                            <a class="nav-link" href="#"><span><i class="fa fa-briefcase"></i></span>Booking</a></li>
                                        <li class="nav-item">
