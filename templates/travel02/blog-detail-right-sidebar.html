                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown dropdown-submenu active"><a href="#" class="dropdown-toggle dropdown-item" data-bs-toggle="dropdown">Blog</a>
                                        <ul class="dropdown-menu dropdown-sbm left-sbm">
                                            ...
                                            <li class="active"><a href="blog-detail-right-sidebar.html" class="dropdown-item">Blog Detail Right Sidebar</a></li>
                                        </ul>
                                    </li>
                        ...
                        <div class="list-group panel">
                                    ...
                                    <div class="collapse sub-menu mega-sub-menu" id="features-links">
                                        ...
                                        <div class="collapse sub-menu mega-sub-menu-links" id="f-blog-links">
                                            ...
                                            <a class="items-list active" href="blog-detail-right-sidebar.html">Blog Detail Right Sidebar</a>
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">Blog Details Right Sidebar</li>
                            </ul>
                        </div><!-- end columns -->
                    </div><!-- end row -->
                </div><!-- end container -->
                                        ...
                                        <div class="main-img blog-post-img">
                                            ...
                                            <div class="main-mask blog-post-info">
                                                <ul class="list-inline list-unstyled blog-post-info">
                                                    <li class="list-inline-item list-inline-item"><span><i class="fa fa-calendar"></i></span>July 30, 2017</li>
                                                    <li class="list-inline-item list-inline-item"><span><i class="fa fa-user"></i></span>By: <a href="#">John Smith</a></li>
                                                </ul>
                                            </div>
