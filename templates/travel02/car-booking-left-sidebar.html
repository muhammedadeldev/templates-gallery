...
<html lang="en">
    <head>
        <title>Car Booking Left Sidebar</title>
        <meta charset="utf-8">
...
<div class="wrapper">
                ...
                <ul class="navbar-nav ms-auto navbar-search-link">
                    ...
                    <li class="nav-item dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a class="dropdown-item" href="car-booking-left-sidebar.html">Booking Left Sidebar</a></li>
            ...
            <div id="main-menu">
                ...
                <div class="list-group panel">
                            ...
                            <div class="collapse sub-menu" id="cars-links">
                                ...
                                <a class="items-list active" href="car-booking-left-sidebar.html">Booking Left Sidebar</a>
    ...
    <!--================== PAGE-COVER ================-->
    <section class="page-cover" id="cover-car-booking">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-title">Car Booking Left Sidebar</h1>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item">Car Booking Left Sidebar</li>
                    </ul>
                </div><!-- end columns -->
            </div><!-- end row -->
        </div><!-- end container -->
    ...
    <section class="innerpage-wrapper">
        <div id="car-booking" class="innerpage-section-padding">
            <div class="container">
                <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-12">
                                <div class="side-bar-block detail-block style2 text-center">
                                    <div class="detail-img text-center">
                                        <a href="#"><img src="images/car-grid-1.jpg" class="img-fluid" alt="detail-img"/></a>
                                        <div class="detail-title">
                                            <h4><a href="#">Luxury</a></h4>
                                            <p>BMW</p>
                                        </div><!-- end detail-title -->
                                        
                                        <span class="detail-price"><h4>$180 <span>/ Day</span></h4></span>
                                    </div><!-- end detail-img -->
                        ...
                        <form class="lg-booking-form" id="frm_booking" name="frm_booking" method="post">
                            ...
                            <div class="payment-tabs">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="#tab-credit-card" data-bs-toggle="tab"> Via Credit Card</a></li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#tab-paypal" data-bs-toggle="tab">Via Paypal</a></li>
                                </ul>
