...
<html lang="en">
<head>
    <title>Flight Booking Left Sidebar</title>
    <meta charset="utf-8">
                    ...
                    <ul class="navbar-nav ms-auto navbar-search-link">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a class="dropdown-item" href="flight-booking-left-sidebar.html">Booking Left Sidebar</a></li>
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu" id="flights-links">
                                    ...
                                    <a class="items-list active" href="flight-booking-left-sidebar.html">Booking Left Sidebar</a>
