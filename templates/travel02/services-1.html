    ...
    <div class="wrapper">
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu" id="pages-links">
                                    ...
                                    <a class="items-list active" href="services-1.html">Services 1</a>
        ...
        <section class="page-cover" id="cover-services">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-title">Services 1</h1>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item">Services 1</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-12 col-lg-7 col-xl-7" id="why-us-tabs">
                                    ...
                                    <ul class="nav nav-tabs">
                                        <li class="nav-item"><a class="nav-link active" href="#tb-happy-client" data-bs-toggle="tab"><span><i class="fa fa-smile-o"></i></span>Happy Clients</a></li>
                                        <li class="nav-item"><a class="nav-link" href="#tb-satisfaction" data-bs-toggle="tab"><span><i class="fa fa-thumbs-o-up"></i></span>Satisfaction</a></li>
                                        <li class="nav-item"><a class="nav-link" href="#tb-daily-tours" data-bs-toggle="tab"><span><i class="fa fa-plane"></i></span>Daily Tours</a></li>
                                    </ul><!-- end nav-tabs -->
