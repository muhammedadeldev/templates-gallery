                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md">
                                            <ul class="list-unstyled">
                                                ...
                                                <li class="active"><a href="travel-insurance.html">Travel Insurance</a></li>
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu" id="pages-links">
                                    ...
                                    <a class="items-list active" href="travel-insurance.html">Travel Insurance</a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Travel Insurance</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
            ...
            <div id="travel-insurance" class="innerpage-section-padding">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12 col-lg-9 col-xl-9 content-side tvl-insurance-info">
                            <div class="space-right">
                                <div class="insurance-desc mg-bot-60">
                                    <div class="innerpage-heading">
                                        ...
                                        <img src="images/travel-insurance.jpg" class="img-fluid" alt="travel-insurance" />
                                        ...
                                        <div class="col-12 col-md-6 col-lg-6">
                                            <div class="in-feature-block text-center">
                                                ...
                                                <div class="in-frature-text">
                                                    ...
                                                    <p>Lorem ipsum dolor sit amet, conse adipiscing elit. Curabitur metus felis, venenatis eu ultricies vel.</p>
