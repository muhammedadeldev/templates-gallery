                    ...
                    <ul class="navbar-nav ms-auto navbar-search-link">
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li class="active"><a class="dropdown-item" href="car-homepage.html">Car Homepage</a></li>
            ...
            <div id="main-menu">
                ...
                <div class="list-group panel">
                            ...
                            <div class="collapse sub-menu text-danger" id="home-links">
                                ...
                                <a class="items-list active" href="car-homepage.html">Car Homepage</a>
                            ...
                            <div class="collapse sub-menu" id="pages-links">
                                ...
                                <a class="items-list" href="#" class="active">About Us 1</a>
    ...
    <section class="flexslider-container" id="flexslider-container-3">
        ...
        <div class="flexslider slider" id="slider-3">
            <ul class="slides">
                ...
                <li class="item-1 back-size" style="background:            linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.3)),url(images/car-slider-1.jpg) 50% 65%; background-size:cover; height:100%;">
                </li><!-- end item-1 -->
                
                <li class="item-2 back-size" style="background:linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.3)),url(images/car-slider-1.jpg) 50% 65%; background-size:cover; height:100%;">
                </li><!-- end item-2 -->
        ...
        <div class="search-tabs" id="search-tabs-3">
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-6 col-xl-6 no-pd-r">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item"><a class="nav-link" href="#hotels" data-bs-toggle="tab"><span><i class="fa fa-building"></i></span><span class="st-text">Hotels</span></a></li>
                            ...
                            <li class="nav-item"><a class="nav-link active" href="#cars" data-bs-toggle="tab"><span><i class="fa fa-car"></i></span><span class="st-text">Cars</span></a></li>
                        </ul>
                    ...
                    <div class="owl-carousel owl-theme owl-custom-arrow" id="owl-car-offers">
                            ...
                            <div class="main-block car-offer-block">
                                <div class="main-img car-offer-img">
                                    <a href="car-detail-right-sidebar.html">
                                        <img src="images/car-1.jpg" class="img-fluid" alt="car-img" />
                                    </a>
                        ...
                        <div class="item">
                            <div class="main-block car-offer-block">
                                <div class="main-img car-offer-img">
                                    <a href="car-detail-right-sidebar.html">
                                        <img src="images/car-2.jpg" class="img-fluid" alt="car-img" />
                                    </a>
                                </div><!-- end car-offer-img -->
                        ...
                        <div class="item">
                            <div class="main-block car-offer-block">
                                <div class="main-img car-offer-img">
                                    <a href="car-detail-right-sidebar.html">
                                        <img src="images/car-3.jpg" class="img-fluid" alt="car-img" />
                                    </a>
                                </div><!-- end car-offer-img -->
                        ...
                        <div class="item">
                            <div class="main-block car-offer-block">
                                <div class="main-img car-offer-img">
                                    <a href="car-detail-right-sidebar.html">
                                        <img src="images/car-4.jpg" class="img-fluid" alt="car-img" />
                                    </a>
                                </div><!-- end car-offer-img -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-12 col-lg-6 col-xl-6 no-pd-r luxury-img">
                    <img src="images/luxury-car.jpg" class="img-fluid" alt="luxury-car" />
                </div>
    ...
    <section id="message-banner" class="section-padding back-size"> 
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-12 col-lg-12 col-xl-3 message-btn text-end">
