                ...
                <ul class="navbar-nav ms-auto navbar-search-link">
                    ...
                    <li class="nav-item dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a class="dropdown-item" href="car-search-result.html">Search Result</a></li>
            ...
            <div id="main-menu">
                ...
                <div class="list-group panel">
                            ...
                            <div class="collapse sub-menu" id="cars-links">
                                ...
                                <a class="items-list active" href="car-search-result.html">Search Result</a>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Car Search Result</li>
                    </ul>
                </div><!-- end columns -->
            </div><!-- end row -->
        </div><!-- end container -->
                            ...
                            <form class="pg-search-form">
                                <div class="row">
                                    <div class="col-12 col-md-6 col-lg-3 col-xl-3">
                                        <div class="form-group">
                                            <label><span><i class="fa fa-map-marker"></i></span>Pick Up Location</label>
                                            <input class="form-control" placeholder="Destination, City"/>
                                        </div>
                                    </div><!-- end columns -->
                                    
                                    <div class="col-12 col-md-6 col-lg-3 col-xl-3">
                                        <div class="form-group">
                                            <label><span><i class="fa fa-map-marker"></i></span>Drop Off Location</label>
                                            <input class="form-control" placeholder="Destination, City"/>
                                        </div>
                                    </div><!-- end columns -->
