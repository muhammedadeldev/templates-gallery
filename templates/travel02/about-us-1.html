                                    ...
                                    <div class="row">
                                        <div class="col-md">
                                            <ul class="list-unstyled">
                                                ...
                                                <li class="active"><a href="#">About Us 1</a></li>
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu" id="pages-links">
                                    ...
                                    <a class="items-list active" href="#">About Us 1</a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">About Us 1</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
                            ...
                            <div class="col-sm-12">
                                <div class="flex-content">
                                    <div class="flex-content-img about-img">
                                        <img src="images/about-us.jpg" class="img-fluid" alt="about-img" />
                                </div><!-- end about-img -->
