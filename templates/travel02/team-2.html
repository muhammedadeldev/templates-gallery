    ...
    <div class="wrapper">
                                    ...
                                    <div class="row">
                                        <div class="col-md">
                                            <ul class="list-unstyled">
                                                ...
                                                <li class="active"><a href="team-2.html">Our Team 2</a></li>
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu" id="pages-links">
                                    ...
                                    <a class="items-list active" href="team-2.html">Our Team 2</a>
        ...
        <section class="page-cover" id="cover-team">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-title">Our Team 2</h1>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item">Our Team 2</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="member-block-2 text-center">
                                        <div class="member-img-2">
                                            <img src="images/team-member-2-1.jpg" class="img-fluid" alt="member-img" />
                                ...
                                <div class="col-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="member-block-2 text-center">
                                        <div class="member-img-2">
                                            <img src="images/team-member-2-2.jpg" class="img-fluid" alt="member-img" />
                                ...
                                <div class="col-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="member-block-2 text-center">
                                        <div class="member-img-2">
                                            <img src="images/team-member-2-3.jpg" class="img-fluid" alt="member-img" />
                                ...
                                <div class="col-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="member-block-2 text-center">
                                        <div class="member-img-2">
                                            <img src="images/team-member-2-4.jpg" class="img-fluid" alt="member-img" />
                                ...
                                <div class="col-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="member-block-2 text-center">
                                        <div class="member-img-2">
                                            <img src="images/team-member-2-5.jpg" class="img-fluid" alt="member-img" />
                                ...
                                <div class="col-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="member-block-2 text-center">
                                        <div class="member-img-2">
                                            <img src="images/team-member-2-6.jpg" class="img-fluid" alt="member-img" />
