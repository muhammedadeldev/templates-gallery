                    ...
                    <ul class="navbar-nav ms-auto navbar-search-link">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown dropdown-submenu active"><a href="#" class="dropdown-toggle dropdown-item" data-bs-toggle="dropdown">Gallery</a>
                                    <ul class="dropdown-menu dropdown-sbm left-sbm">
                                        ...
                                        <li class="active"><a href="gallery-4-columns.html" class="dropdown-item">Gallery 4 Columns</a></li>
                                    </ul>
                                </li>
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu mega-sub-menu" id="features-links">
                                    ...
                                    <a class="items-list active" href="#f-gallery-links" data-bs-toggle="collapse">Gallery<span><i class="fa fa-caret-down arrow"></i></span></a>
                                    <div class="collapse sub-menu mega-sub-menu-links" id="f-gallery-links">
                                        ...
                                        <a class="items-list active" href="gallery-4-columns.html">Gallery 4 Columns</a>
                                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Gallery-4-columns</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
                        ...
                        <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                            ...
                            <div class="row">
                                    ...
                                    <div class="gallery-product col-12 col-md-6 col-lg-4 col-xl-3">
                                        <div class="gallery-block">
                                            <div class="gallery-img ">
                                                <img src="images/gallery-1.jpg" class="img-fluid" alt="gallery-img" >
                                                <div class="gallery-mask">
                                                    <div class="gallery-title">
                                                            <h2>Image Title</h2>
                                                            <p>2 Pictures</p>
                                                        </div>  <!-- end gallery-title --> 
                                                    <a href="images/gallery-1.jpg" title="image-1" class="with-caption image-link"><span><i class="fa fa-arrows-v"></i></span></a>
                                    ...
                                    <div class="gallery-product col-12 col-md-6 col-lg-4 col-xl-3">
                                        <div class="gallery-block">
                                            <div class="gallery-img ">
                                                <img src="images/gallery-2.jpg" class="img-fluid" alt="gallery-img" >
                                                <div class="gallery-mask">
                                                    <div class="gallery-title">
                                                            <h2>Image Title</h2>
                                                            <p>2 Pictures</p>
                                                        </div>  <!-- end gallery-title --> 
                                                    <a href="images/gallery-2.jpg" title="image-2" class="with-caption image-link"><span><i class="fa fa-arrows-v"></i></span></a>
                                                </div><!-- end gallery-mask -->
                                            </div><!-- end gallery-img -->
                                        </div><!-- end gallery-block -->
                                    </div><!-- end gallery-product -->
                                    ...
                                    <div class="gallery-product col-12 col-md-6 col-lg-4 col-xl-3">
                                        <div class="gallery-block">
                                            <div class="gallery-img ">
                                                <img src="images/gallery-3.jpg" class="img-fluid" alt="gallery-img" >
                                                <div class="gallery-mask">
                                                    <div class="gallery-title">
                                                            <h2>Image Title</h2>
                                                            <p>2 Pictures</p>
                                                        </div>  <!-- end gallery-title --> 
                                                    <a href="images/gallery-3.jpg" title="image-3" class="with-caption image-link"><span><i class="fa fa-arrows-v"></i></span></a>
                                                </div><!-- end gallery-mask -->
                                            </div><!-- end gallery-img -->
                                        </div><!-- end gallery-block -->
                                    </div><!-- end gallery-product -->
                                    ...
                                    <div class="gallery-product col-12 col-md-6 col-lg-4 col-xl-3">
                                        <div class="gallery-block">
                                            <div class="gallery-img ">
                                                <img src="images/gallery-4.jpg" class="img-fluid" alt="gallery-img" >
                                                <div class="gallery-mask">
                                                    <div class="gallery-title">
                                                            <h2>Image Title</h2>
                                                            <p>2 Pictures</p>
                                                        </div>  <!-- end gallery-title --> 
                                                    <a href="images/gallery-4.jpg" title="image-4" class="with-caption image-link"><span><i class="fa fa-arrows-v"></i></span></a>
                                                </div><!-- end gallery-mask -->
                                            </div><!-- end gallery-img -->
                                        </div><!-- end gallery-block -->
                                    </div><!-- end gallery-product -->
                                    ...
                                    <div class="gallery-product col-12 col-md-6 col-lg-4 col-xl-3">
                                        <div class="gallery-block">
                                            <div class="gallery-img ">
                                                <img src="images/gallery-5.jpg" class="img-fluid" alt="gallery-img" >
                                                <div class="gallery-mask">
                                                    <div class="gallery-title">
                                                            <h2>Image Title</h2>
                                                            <p>2 Pictures</p>
                                                        </div>  <!-- end gallery-title --> 
                                                    <a href="images/gallery-5.jpg" title="image-5" class="with-caption image-link"><span><i class="fa fa-arrows-v"></i></span></a>
                                                </div><!-- end gallery-mask -->
                                            </div><!-- end gallery-img -->
                                        </div><!-- end gallery-block -->
                                    </div><!-- end gallery-product -->
                                    ...
                                    <div class="gallery-product col-12 col-md-6 col-lg-4 col-xl-3">
                                        <div class="gallery-block">
                                            <div class="gallery-img ">
                                                <img src="images/gallery-6.jpg" class="img-fluid" alt="gallery-img" >
                                                <div class="gallery-mask">
                                                    <div class="gallery-title">
                                                            <h2>Image Title</h2>
                                                            <p>2 Pictures</p>
                                                        </div>  <!-- end gallery-title --> 
                                                    <a href="images/gallery-6.jpg" title="image-6" class="with-caption image-link"><span><i class="fa fa-arrows-v"></i></span></a>
                                                </div><!-- end gallery-mask -->
                                            </div><!-- end gallery-img -->
                                        </div><!-- end gallery-block -->
                                    </div><!-- end gallery-product -->
                                    ...
                                    <div class="gallery-product col-12 col-md-6 col-lg-4 col-xl-3">
                                        <div class="gallery-block">
                                            <div class="gallery-img ">
                                                <img src="images/gallery-7.jpg" class="img-fluid" alt="gallery-img" >
                                                <div class="gallery-mask">
                                                    <div class="gallery-title">
                                                            <h2>Image Title</h2>
                                                            <p>2 Pictures</p>
                                                        </div>  <!-- end gallery-title --> 
                                                    <a href="images/gallery-7.jpg" title="image-7" class="with-caption image-link"><span><i class="fa fa-arrows-v"></i></span></a>
                                                </div><!-- end gallery-mask -->
                                            </div><!-- end gallery-img -->
                                        </div><!-- end gallery-block -->
                                    </div><!-- end gallery-product -->
                                    ...
                                    <div class="gallery-product col-12 col-md-6 col-lg-4 col-xl-3">
                                        <div class="gallery-block">
                                            <div class="gallery-img ">
                                                <img src="images/gallery-8.jpg" class="img-fluid" alt="gallery-img" >
                                                <div class="gallery-mask">
                                                    <div class="gallery-title">
                                                            <h2>Image Title</h2>
                                                            <p>2 Pictures</p>
                                                        </div>  <!-- end gallery-title --> 
                                                    <a href="images/gallery-8.jpg" title="image-8" class="with-caption image-link"><span><i class="fa fa-arrows-v"></i></span></a>
                                                </div><!-- end gallery-mask -->
                                            </div><!-- end gallery-img -->
                                        </div><!-- end gallery-block -->
                                    </div><!-- end gallery-product -->
