...
<body>
    ...
    <div class="wrapper">
                    ...
                    <ul class="navbar-nav ms-auto navbar-search-link">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a class="dropdown-item" href="hotel-offers.html">Hot Offers</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
            ...
            <nav id="sidebar" class="sidenav">
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                                ...
                                <a class="items-list active" href="#hotels-links" data-bs-toggle="collapse"><span><i class="fa fa-building link-icon"></i></span>Hotels<span><i class="fa fa-chevron-down arrow"></i></span></a>
                                <div class="collapse sub-menu" id="hotels-links">
                                    ...
                                    <a class="items-list active" href="hotel-offers.html">Hot Offers</a>
                                </div><!-- end sub-menu -->
        ...
        <!--================== PAGE-COVER ===============-->
        <section class="page-cover" id="cover-hotel-offers">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-title">Hotel Offers</h1>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item">Hotel Offers</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
        ...
        <section class="innerpage-wrapper">
            <div id="hotel-offers" class="innerpage-section-padding">
                <div class="container">
                    <div class="row">
                            ...
                            <div class="row">
                                    ...
                                    <div class="grid-block main-block h-grid-block">
                                        <div class="main-img h-grid-img">
                                            <a href="hotel-detail-left-sidebar.html">
                                                <img src="images/hotel-grid-1.jpg" class="img-fluid" alt="hotel-img" />
                                                <div class="offer-tag">
                                                    <span>12% Off</span>
                                                </div><!-- end offer-tag -->
                                            </a>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="grid-block main-block h-grid-block">
                                        <div class="main-img h-grid-img">
                                            <a href="hotel-detail-left-sidebar.html">
                                                <img src="images/hotel-grid-2.jpg" class="img-fluid" alt="hotel-img" />
                                                <div class="offer-tag">
                                                    <span>12% Off</span>
                                                </div><!-- end offer-tag -->
                                            </a>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="grid-block main-block h-grid-block">
                                        <div class="main-img h-grid-img">
                                            <a href="hotel-detail-left-sidebar.html">
                                                <img src="images/hotel-grid-3.jpg" class="img-fluid" alt="hotel-img" />
                                                <div class="offer-tag">
                                                    <span>12% Off</span>
                                                </div><!-- end offer-tag -->
                                            </a>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="grid-block main-block h-grid-block">
                                        <div class="main-img h-grid-img">
                                            <a href="hotel-detail-left-sidebar.html">
                                                <img src="images/hotel-grid-4.jpg" class="img-fluid" alt="hotel-img" />
                                                <div class="offer-tag">
                                                    <span>12% Off</span>
                                                </div><!-- end offer-tag -->
                                            </a>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="grid-block main-block h-grid-block">
                                        <div class="main-img h-grid-img">
                                            <a href="hotel-detail-left-sidebar.html">
                                                <img src="images/hotel-grid-5.jpg" class="img-fluid" alt="hotel-img" />
                                                <div class="offer-tag">
                                                    <span>12% Off</span>
                                                </div><!-- end offer-tag -->
                                            </a>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="grid-block main-block h-grid-block">
                                        <div class="main-img h-grid-img">
                                            <a href="hotel-detail-left-sidebar.html">
                                                <img src="images/hotel-grid-6.jpg" class="img-fluid" alt="hotel-img" />
                                                <div class="offer-tag">
                                                    <span>12% Off</span>
                                                </div><!-- end offer-tag -->
                                            </a>
