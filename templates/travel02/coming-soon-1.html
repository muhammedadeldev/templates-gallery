                	...
                	<div class="row">
                		<div class="col-md-12">
                            ...
                            <ul class="list-inline list-unstyled timer">
                            	<li class="list-inline-item"><span class="digit">24</span>days</li>
                                <li class="list-inline-item"><span class="digit">23</span>hours</li>
                                <li class="list-inline-item"><span class="digit">59</span>minutes</li>
                                <li class="list-inline-item"><span class="digit">45</span>seconds</li>
                            </ul>
                        </div><!-- end columns -->
                    </div><!-- end row -->
                </div><!-- end container -->
