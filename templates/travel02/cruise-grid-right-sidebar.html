...
<html lang="en">
<head>
    <title>Cruise Grid Right Sidebar</title>
    <meta charset="utf-8">
...
<div class="wrapper">
                ...
                <ul class="navbar-nav ms-auto navbar-search-link">
                    ...
                    <li class="nav-item dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a class="dropdown-item" href="cruise-grid-right-sidebar.html">Grid View Right Sidebar</a></li>
            ...
            <div id="main-menu">
                ...
                <div class="list-group panel">
                            ...
                            <div class="collapse sub-menu" id="cruise-links">
                                ...
                                <a class="items-list active" href="cruise-grid-right-sidebar.html">Grid View Right Sidebar</a>
    ...
    <section class="page-cover" id="cover-cruise-grid-list">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-title">Cruise Grid Right Sidebar</h1>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item">Cruise Grid Right Sidebar</li>
                    </ul>
                </div><!-- end columns -->
            </div><!-- end row -->
        </div><!-- end container -->
                        ...
                        <div class="row">
                                ...
                                <div class="grid-block main-block crs-grid-block">
                                    <div class="main-img crs-grid-img">
                                        <a href="cruise-detail-left-sidebar.html">
                                            <img src="images/cruise-grid-1.jpg" class="img-fluid" alt="hotel-img" />
                                        </a>
                                        <div class="main-mask">
                                            <ul class="list-unstyled list-inline offer-price-1">
                                                <li class="price">$568.00<span class="divider">|</span><span class="pkg">6 Nights, 7 Days</span></li>
                                            </ul>
                                        </div><!-- end main-mask -->
                                     ...
                                     <div class="block-info crs-grid-info">
                                        ...
                                        <div class="grid-btn">
                                            <a href="cruise-detail-left-sidebar.html" class="btn btn-orange btn-block btn-lg">View More</a>
                                        </div><!-- end grid-btn -->
                            ...
                            <div class="col-md-6 col-lg-6 col-xl-4">
                                <div class="grid-block main-block crs-grid-block">
                                    <div class="main-img crs-grid-img">
                                        <a href="cruise-detail-left-sidebar.html">
                                            <img src="images/cruise-grid-2.jpg" class="img-fluid" alt="hotel-img" />
                                        </a>
                                        <div class="main-mask">
                                            <ul class="list-unstyled list-inline offer-price-1">
                                                <li class="price">$568.00<span class="divider">|</span><span class="pkg">6 Nights, 7 Days</span></li>
                            ...
                            <div class="col-md-6 col-lg-6 col-xl-4">
                                <div class="grid-block main-block crs-grid-block">
                                    <div class="main-img crs-grid-img">
                                        <a href="cruise-detail-left-sidebar.html">
                                            <img src="images/cruise-grid-3.jpg" class="img-fluid" alt="hotel-img" />
                                        </a>
                                        <div class="main-mask">
                                            <ul class="list-unstyled list-inline offer-price-1">
                                                        <li class="price">$568.00<span class="divider">|</span><span class="pkg">6 Nights, 7 Days</span></li>
                            ...
                            <div class="col-md-6 col-lg-6 col-xl-4">
                                <div class="grid-block main-block crs-grid-block">
                                    <div class="main-img crs-grid-img">
                                        <a href="cruise-detail-left-sidebar.html">
                                            <img src="images/cruise-grid-4.jpg" class="img-fluid" alt="hotel-img" />
                                        </a>
                                        <div class="main-mask">
                                            <ul class="list-unstyled list-inline offer-price-1">
                                                <li class="price">$568.00<span class="divider">|</span><span class="pkg">6 Nights, 7 Days</span></li>
                            ...
                            <div class="col-md-6 col-lg-6 col-xl-4">
                                <div class="grid-block main-block crs-grid-block">
                                    <div class="main-img crs-grid-img">
                                        <a href="cruise-detail-left-sidebar.html">
                                            <img src="images/cruise-grid-5.jpg" class="img-fluid" alt="hotel-img" />
                                        </a>
                                        <div class="main-mask">
                                            <ul class="list-unstyled list-inline offer-price-1">
                                                <li class="price">$568.00<span class="divider">|</span><span class="pkg">6 Nights, 7 Days</span></li>
                            ...
                            <div class="col-md-6 col-lg-6 col-xl-4">
                                <div class="grid-block main-block crs-grid-block">
                                    <div class="main-img crs-grid-img">
                                        <a href="cruise-detail-left-sidebar.html">
                                            <img src="images/cruise-grid-6.jpg" class="img-fluid" alt="hotel-img" />
                                        </a>
                                        <div class="main-mask">
                                            <ul class="list-unstyled list-inline offer-price-1">
                                                <li class="price">$568.00<span class="divider">|</span><span class="pkg">6 Nights, 7 Days</span></li>
