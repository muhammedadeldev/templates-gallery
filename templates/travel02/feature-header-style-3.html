...
<html lang="en">
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu mega-sub-menu" id="features-links">
                                    ...
                                    <div class="collapse sub-menu mega-sub-menu-links" id="header-style-links">
                                        ...
                                        <a class="items-list active" href="feature-header-style-3.html">Header Style 3</a>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="dropdown-submenu active"><a href="#" class="dropdown-toggle dropdown-item" data-bs-toggle="dropdown">Header</a>
                                            <ul class="dropdown-menu dropdown-sbm left-sbm">
                                                ...
                                                <li class="active"><a href="feature-header-style-3.html" class="dropdown-item">Header Style 3</a></li>
    ...
    <a href="#" class="search-button" onclick="openSearch()"><span><i class="fa fa-search"></i></span></a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                    	<h1 class="page-title">Header Style 3</h1>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item">Header Style 3</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
