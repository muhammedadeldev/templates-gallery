                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown dropdown-submenu active"><a href="#" class="dropdown-toggle dropdown-item" data-bs-toggle="dropdown">Blog</a>
                                    <ul class="dropdown-menu dropdown-sbm left-sbm">
                                        <li class="active"><a href="blog-listing-left-sidebar.html" class="dropdown-item">Blog Listing Left Sidebar</a></li>
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu mega-sub-menu" id="features-links">
                                    ...
                                    <div class="collapse sub-menu mega-sub-menu-links" id="f-blog-links">
                                        <a class="items-list active" href="blog-listing-left-sidebar.html">Blog Listing Left Sidebar</a>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Blog Listing Left Sidebar</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
                                    ...
                                    <div class="side-bar-block recent-post">
                                        ...
                                        <div class="recent-block">
                                            <div class="recent-img">
                                                <a href="blog-detail-left-sidebar.html"><img src="images/recent-post-1.jpg" class="img-fluid" alt="recent-blog-image" /></a>
                                            </div><!-- end recent-img -->
                                        ...
                                        <div class="recent-block">
                                            <div class="recent-img">
                                                <a href="blog-detail-left-sidebar.html"><img src="images/recent-post-2.jpg" class="img-fluid" alt="recent-blog-image" /></a>
                                            </div><!-- end recent-img -->
                                        ...
                                        <div class="recent-block">
                                            <div class="recent-img">
                                                <a href="blog-detail-left-sidebar.html"><img src="images/recent-post-3.jpg" class="img-fluid" alt="recent-blog-image" /></a>
                                            </div><!-- end recent-img -->
                            ...
                            <div class="space-right">
                                ...
                                <div class="main-block blog-post blog-list">
                                    ...
                                    <div class="blog-post-detail">
                                        <h2 class="blog-post-title"><a href="blog-detail-left-sidebar.html">The perfect summer destinations</a></h2>
                                ...
                                <div class="main-block blog-post blog-list">
                                    <div class="main-img blog-post-img">
                                        <a href="blog-detail-left-sidebar.html">
                                            <img src="images/blog-listing-2.jpg" class="img-fluid" alt="blog-post-image" />
                                        </a>
                                        <div class="main-mask">
                                            <ul class="list-inline list-unstyled blog-post-info">
                                                <li class="list-inline-item"><span><i class="fa fa-calendar"></i></span>July 30, 2017</li>
                                ...
                                <div class="main-block blog-post blog-list">
                                    <div class="main-img blog-post-img">
                                        <a href="blog-detail-left-sidebar.html">
                                            <img src="images/blog-listing-3.jpg" class="img-fluid" alt="blog-post-image" />
                                        </a>
                                        <div class="main-mask">
                                            <ul class="list-inline list-unstyled blog-post-info">
                                                <li class="list-inline-item"><span><i class="fa fa-calendar"></i></span>July 30, 2017</li>
            ...
            <div id="footer-bottom" class="ftr-bot-black">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6" id="terms">
                            <ul class="list-unstyled list-inline">
