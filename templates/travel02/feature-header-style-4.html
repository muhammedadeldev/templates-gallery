...
<div class="wrapper">
    ...
    <nav class="navbar navbar-expand-xl sticky-top main-navbar navbar-custom navbar-colored" id="mynav1">
        <div class="container">
            ...
            <div class="header-search d-block my-auto ms-auto py-1">
                        ...
                        <ul class="dropdown-menu">
                            <li class="dropdown-submenu active"><a href="#" class="dropdown-toggle dropdown-item" data-bs-toggle="dropdown">Header</a>
                                <ul class="dropdown-menu dropdown-sbm left-sbm">
                                    ...
                                    <li class="active"><a href="feature-header-style-4.html" class="dropdown-item">Header Style 4</a></li>
                ...
                <div class="list-group panel">
                            ...
                            <div class="collapse sub-menu mega-sub-menu" id="features-links">
                                ...
                                <div class="collapse sub-menu mega-sub-menu-links" id="header-style-links">
                                    ...
                                    <a class="items-list active" href="feature-header-style-4.html">Header Style 4</a>
    ...
    <!--========= PAGE-COVER =========-->
    <section class="page-cover back-img">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-title">Header Style 4</h1>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item">Header Style 4</li>
                    </ul>
                </div><!-- end columns -->
            </div><!-- end row -->
        </div><!-- end container -->
