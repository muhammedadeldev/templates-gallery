...
<html lang="en">
    <head>
        <title>Cruise Listing Right Sidebar</title>
        <meta charset="utf-8">
    ...
    <div class="wrapper">
                    ...
                    <ul class="navbar-nav ms-auto navbar-search-link">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a class="dropdown-item" href="cruise-listing-right-sidebar.html">List View Right Sidebar</a></li>
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu" id="cruise-links">
                                    ...
                                    <a class="items-list active" href="cruise-listing-right-sidebar.html">List View Right Sidebar</a>
        ...
        <section class="page-cover" id="cover-cruise-grid-list">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-title">Cruise Listing Right Sidebar</h1>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item">Cruise Listing Right Sidebar</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
        ...
        <section class="innerpage-wrapper">
            <div id="cruise-listing" class="innerpage-section-padding">
                <div class="container">
                    <div class="row">            
                        ...
                        <div class="col-12 col-md-12 col-lg-9 col-xl-9 content-side">
                            ...
                            <div class="list-block main-block crs-list-block">
                                <div class="list-content">
                                    <div class="main-img list-img crs-list-img">
                                        <a href="cruise-detail-left-sidebar.html">
                                            <img src="images/cruise-list-5.jpg" class="img-fluid" alt="cruise-img" />
                                        </a>
                                        <div class="main-mask">
                                            <ul class="list-unstyled list-inline offer-price-1">
                                                <li class="list-inline-item price">$1250<span class="divider">|</span><span class="pkg">6 Night, 7 Days</span></li>
                            ...
                            <div class="list-block main-block crs-list-block">
                                <div class="list-content">
                                    <div class="main-img list-img crs-list-img">
                                        <a href="cruise-detail-left-sidebar.html">
                                            <img src="images/cruise-list-6.jpg" class="img-fluid" alt="cruise-img" />
                                        </a>
                                        <div class="main-mask">
                                            <ul class="list-unstyled list-inline offer-price-1">
                                                <li class="list-inline-item price">$1250<span class="divider">|</span><span class="pkg">6 Night, 7 Days</span></li>
                                ...
                                <div class="panels-group">
                                    ...
                                    <div class="card">
                                        <div class="card-header">                    
                                            <a href="#panel-1" data-bs-toggle="collapse" >Pick-Up Time <span><i class="fa fa-calendar"></i></span></a>
                                        </div><!-- end card-header -->
                                        ...
                                        <div id="panel-1" class="panel-collapse collapse">
                                            <div class="card-body text-start">
                                                <ul class="list-unstyled">
                                                    ...
                                                    <label for="check02"><span><i class="fa fa-check"></i></span>08:00 AM</label></li>
                                                    <li class="custom-check"><input type="checkbox" id="check03" name="checkbox"/>
                                                    <label for="check03"><span><i class="fa fa-check"></i></span>12:00 PM</label></li>
                                                    <li class="custom-check"><input type="checkbox" id="check04" name="checkbox"/>
                                                    <label for="check04"><span><i class="fa fa-check"></i></span>05:00 PM</label></li>
                                                </ul>
                                            </div><!-- end card-body -->
                                    ...
                                    <div class="card">
                                        <div class="card-header">                    
                                            <a href="#panel-2" data-bs-toggle="collapse" >From - To<span><i class="fa fa-angle-down"></i></span></a>
                                        </div><!-- end card-header -->
                                        ...
                                        <div id="panel-2" class="panel-collapse collapse">
                                            <div class="card-body text-start">
                                                <ul class="list-unstyled">
                                                    ...
                                                    <label for="check05"><span><i class="fa fa-check"></i></span>All</label></li>
                                                    <li class="custom-check"><input type="checkbox" id="check06" name="checkbox"/>
                                                    <label for="check06"><span><i class="fa fa-check"></i></span>Belgium - Greek</label></li>
                                                    <li class="custom-check"><input type="checkbox" id="check07" name="checkbox"/>
                                                    <label for="check07"><span><i class="fa fa-check"></i></span>Italy - Spain</label></li>
                                                    <li class="custom-check"><input type="checkbox" id="check08" name="checkbox"/>
                                                    <label for="check08"><span><i class="fa fa-check"></i></span>Alacati - Istanbul</label></li>
                                                    <li class="custom-check"><input type="checkbox" id="check09" name="checkbox"/>
                                                    <label for="check09"><span><i class="fa fa-check"></i></span>France - Mardin</label></li>
                                                </ul>
                                            </div><!-- end card-body -->
                                        </div><!-- end panel-collapse -->
                                    </div><!-- end panel-default -->
                                    ...
                                    <div class="card">
                                        <div class="card-header">                    
                                            <a href="#panel-3" data-bs-toggle="collapse" >Duration <span><i class="fa fa-angle-down"></i></span></a>
                                        </div><!-- end card-header -->
                                        ...
                                        <div id="panel-3" class="panel-collapse collapse">
                                            <div class="card-body text-start">
                                                <ul class="list-unstyled">
                                                    ...
                                                    <label for="check11"><span><i class="fa fa-check"></i></span>24 Hours</label></li>
                                                    <li class="custom-check"><input type="checkbox" id="check12" name="checkbox"/>
                                                    <label for="check12"><span><i class="fa fa-check"></i></span>35 Hours</label></li>
                                                    <li class="custom-check"><input type="checkbox" id="check13" name="checkbox"/>
                                                    <label for="check13"><span><i class="fa fa-check"></i></span>48 Hours</label></li>
                                                </ul>
                                            </div><!-- end card-body -->
                                        </div><!-- end panel-collapse -->
                                    </div><!-- end panel-default -->
                                    ...
                                    <div class="card">
                                        <div class="card-header">                    
                                            <a href="#panel-4" data-bs-toggle="collapse" >Package Type <span><i class="fa fa-angle-down"></i></span></a>
                                        </div><!-- end card-header -->
                                        ...
                                        <div id="panel-4" class="panel-collapse collapse">
                                            <div class="card-body text-start">
                                                <ul class="list-unstyled">
                                                    ...
                                                    <label for="check15"><span><i class="fa fa-check"></i></span>Airfare Package</label></li>
                                                    <li class="custom-check"><input type="checkbox" id="check16" name="checkbox"/>
                                                    <label for="check16"><span><i class="fa fa-check"></i></span>Pre Cruise Package</label></li>
                                                    <li class="custom-check"><input type="checkbox" id="check17" name="checkbox"/>
                                                    <label for="check17"><span><i class="fa fa-check"></i></span>Post Cruise Package</label></li>
                                                </ul>
                                            </div><!-- end card-body -->
                                        </div><!-- end panel-collapse -->
                                    </div><!-- end panel-default -->
