...
<div class="wrapper">
    ...
    <nav class="navbar navbar-expand-xl sticky-top main-navbar navbar-custom nav-white" id="mynavbar-3">
        <div class="container">
        
            <a href="#" class="navbar-brand text-white py-1 m-0"><span><i class="fa fa-plane"></i>STAR</span>TRAVELS</a>
            ...
            <div class="collapse navbar-collapse" id="myNavbar1">
                <ul class="navbar-nav ms-auto navbar-search-link">
                    ...
                    <li class="nav-item dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            <li class="dropdown-submenu active"><a href="#" class="dropdown-toggle dropdown-item" data-bs-toggle="dropdown">Header</a>
                                <ul class="dropdown-menu dropdown-sbm left-sbm">
                                    ...
                                    <li  class="active"><a href="feature-header-style-6.html" class="dropdown-item">Header Style 6</a></li>
                                </ul>
                            </li>
            ...
            <div id="main-menu">
                ...
                <div class="list-group panel">
                            ...
                            <div class="collapse sub-menu mega-sub-menu" id="features-links">
                                <a class="items-list active" href="#header-style-links" data-bs-toggle="collapse">Header<span><i class="fa fa-caret-down arrow"></i></span></a>
                                <div class="collapse sub-menu mega-sub-menu-links" id="header-style-links">
                                    ...
                                    <a class="items-list active" href="feature-header-style-6.html">Header Style 6</a>
                                </div>
    ...
    <!--============= PAGE-COVER =============-->
    <section class="page-cover style cover-navbar-wrapper pt-164">
                    
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-title">Header Style 6</h1>
                    <ul class="breadcrumb">
