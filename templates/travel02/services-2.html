...
<body>
    ...
    <div class="wrapper">
                                    ...
                                    <div class="row">
                                        <div class="col-md">
                                            <ul class="list-unstyled">
                                                ...
                                                <li class="active"><a href="services-2.html">Services 2</a></li>
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu" id="pages-links">
                                    ...
                                    <a class="items-list active" href="services-2.html">Services 2</a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Services 2</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
        ...
        <section class="innerpage-wrapper">
            ...
            <div id="service-intro" class="innerpage-section-padding">
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-md-12 col-lg-5 text-center">
                            <div class="service-intro-img">
                                <img src="images/service-intro.png" class="img-fluid" alt="about-img" />
                            </div><!-- end service-intro-img -->
                        </div><!-- end columns -->
                        
                        <div class="col-12 col-md-12 col-lg-7">
                            <div class="service-intro-text">
                                <h4>Welcome to Star Travel</h4>
                                ...
                                <a href="#" class="btn btn-orange btn-lg">Learn More</a>
            ...
            <div id="services-section">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 col-lg-4 col-lg-pull-4 services-list">
                        ...
                        <div class="col-lg-4 col-lg-push-4 services-list-img text-center">
                            <img src="images/what-we-provide.png" alt="what-we-provide" class="img-fluid">
                        </div><!-- end columns -->
        
                        <div class="col-12 col-md-6 col-lg-4 services-list">
