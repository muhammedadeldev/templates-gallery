            ...
            <div id="main-menu">
                ...
                <div class="list-group panel">
                            ...
                            <div class="collapse sub-menu" id="pages-links">
                                ...
                                <a class="items-list active" href="dashboard-2.html">Dashboard 2</a>
                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        ...
                        <div id="dashboard-tabs">
                            <ul class="nav nav-tabs nav-justified ">
                                <li class="nav-item"><a class="nav-link active" href="#dsh-dashboard" data-bs-toggle="tab"><span><i class="fa fa-cogs"></i></span>Dashboard</a></li>
                                <li class="nav-item"><a class="nav-link" href="#dsh-profile" data-bs-toggle="tab"><span><i class="fa fa-user"></i></span>Profile</a></li>
                                <li class="nav-item"><a class="nav-link" href="#dsh-booking" data-bs-toggle="tab"><span><i class="fa fa-briefcase"></i></span>Booking</a></li>
                                <li class="nav-item"><a class="nav-link" href="#dsh-wishlist" data-bs-toggle="tab"><span><i class="fa fa-heart"></i></span>Wishlist</a></li>
                                <li class="nav-item"><a class="nav-link" href="#dsh-cards" data-bs-toggle="tab"><span><i class="fa fa-credit-card"></i></span>My Cards</a></li>
                            </ul>
                            
                            <div class="tab-content">
                                <div id="dsh-dashboard" class="tab-pane in active">
                                ...
                                <div id="dsh-profile" class="tab-pane">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-7 col-lg-8  user-detail">
                                                        ...
                                                        <button class="btn mt-4" data-bs-toggle="modal" data-bs-target="#edit-profile">Edit Profile</button>
                                                    </div><!-- end columns -->
                                ...
                                <div id="dsh-booking" class="tab-pane">
                                ...
                                <div id="dsh-wishlist" class="tab-pane">
                                            ...
                                            <table class="table table-hover">
                                                <tbody>
                                                    <tr class="list-content">
                                                        <td class="list-img wishlist-img"><img src="images/wishlist.jpg" class="img-fluid d-none d-md-block" alt="wishlist-img" /></td>
                                                        <td class="list-text wishlist-text">
                                                            ...
                                                            <button class="btn btn-lightgrey d-none d-md-block d-lg-none
                                ...
                                <div id="dsh-cards" class="tab-pane">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-lg-6">
                                                <div class="card-block">
                                                    ...
                                                    <ul class="list-unstyled list-inline">
                                                        <li class="list-inline-item"><img src="images/master-card.png" class="img-fluid" alt="card-img" /></li>
                                                        <li class="list-inline-item fa-icons">
                                                            <button class="btn" data-bs-toggle="modal" data-bs-target="#edit-card" ><span><i class="fa fa-pencil"></i></span></button>
                                                            <button class="btn"><span><i class="fa fa-close"></i></span></button>
                                                        </li>
                                                    </ul>
                                                </div><!-- end card-block -->
                                            </div><!-- end columns -->
                                            ...
                                            <div class="col-md-12 col-lg-6">
                                                <a href="#add-card" data-bs-toggle="modal">
