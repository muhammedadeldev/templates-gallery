                ...
                <div class="collapse navbar-collapse" id="myNavbar1">
                    <ul class="navbar-nav ms-auto navbar-search-link">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="tour-homepage.html">Tour Homepage</a></li>
                                <li class="active"><a class="dropdown-item" href="tour-listing-left-sidebar.html">List View Left Sidebar</a></li>
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu" id="tours-links">
                                    <a class="items-list" href="tour-homepage.html">Tour Homepage</a>
                                    <a class="items-list active" href="tour-listing-left-sidebar.html">List View Left Sidebar</a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Tour Listing Left Sidebar</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
                                ...
                                <div class="panels-group">
                                    ...
                                    <div class="card">
                                        <div class="card-header">                    
                                            <a href="#panel-1" data-bs-toggle="collapse" >Select Country <span><i class="fa fa-angle-down"></i></span></a>
                                        </div><!-- end card-header -->
                                    ...
                                    <div class="card">
                                        <div class="card-header">                    
                                            <a href="#panel-2" data-bs-toggle="collapse" >Days <span><i class="fa fa-angle-down"></i></span></a>
                                        </div><!-- end card-header -->
