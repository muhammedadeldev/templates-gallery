...
<div class="wrapper">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md">
                                        <ul class="list-unstyled">
                                            ...
                                            <li class="active"><a href="faq-left-sidebar.html">FAQ Left Sidebar</a></li>
            ...
            <div id="main-menu">
                ...
                <div class="list-group panel">
                            ...
                            <div class="collapse sub-menu" id="pages-links">
                                ...
                                <a class="items-list active" href="faq-left-sidebar.html">FAQ Left Sidebar</a>
    ...
    <section class="page-cover" id="cover-faq">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-title">FAQ Left Sidebar</h1>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item">FAQ Left Sidebar</li>
                    </ul>
                </div><!-- end columns -->
            </div><!-- end row -->
        </div><!-- end container -->
        ...
        <div id="faq-page" class="innerpage-section-padding">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-4 side-bar left-side-bar">
