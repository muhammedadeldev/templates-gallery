        ...
        <section class="flexslider-container" id="flexslider-container-4">
            ...
            <div class="flexslider slider tour-slider" id="slider-4">
                <ul class="slides">
                    ...
                    <li class="item-1 back-size" style="background:linear-gradient(rgba(0,0,0,0.6),rgba(0,0,0,0.6)),url(images/tour-slider-1.jpg) 50% 15%; background-size:cover; height:100%;">
                        <div class="meta">         
                            <div class="container">
                    ...
                    <li class="item-2 back-size" style="background:linear-gradient(rgba(0,0,0,0.6),rgba(0,0,0,0.6)),url(images/tour-slider-1.jpg) 50% 15%; background-size:cover; height:100%;">
                        <div class=" meta">         
                            <div class="container">
                                <span class="highlight-price highlight-2">STARTING FROM 1200$ ONLY</span>
                                <h2>Switzerland</h2>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="nav-item"><a class="nav-link" href="#flights" data-bs-toggle="tab"><span><i class="fa fa-plane"></i></span><span class="d-none d-md-inline-flex st-text">Flights</span></a></li>
                                <li class="nav-item"><a class="nav-link" href="#hotels" data-bs-toggle="tab"><span><i class="fa fa-building"></i></span><span class="d-none d-md-inline-flex st-text">Hotels</span></a></li>
                                <li class="nav-item"><a class="nav-link active" href="#tours" data-bs-toggle="tab"><span><i class="fa fa-suitcase"></i></span><span class="d-none d-md-inline-flex st-text">Tours</span></a></li>
                                <li class="nav-item"><a class="nav-link" href="#cruise" data-bs-toggle="tab"><span><i class="fa fa-ship"></i></span><span class="d-none d-md-inline-flex st-text">Cruise</span></a></li>
                                <li class="nav-item"><a class="nav-link" href="#cars" data-bs-toggle="tab"><span><i class="fa fa-car"></i></span><span class="d-none d-md-inline-flex st-text">Cars</span></a></li>
                            </ul>
