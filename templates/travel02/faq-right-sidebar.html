    ...
    <div class="wrapper">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md">
                                            <ul class="list-unstyled">
                                                ...
                                                <li class="active"><a href="faq-right-sidebar.html">FAQ Right Sidebar</a></li>
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu" id="pages-links">
                                    ...
                                    <a class="items-list active" href="faq-right-sidebar.html">FAQ Right Sidebar</a> 
        ...
        <section class="page-cover" id="cover-faq">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-title">FAQ Right Sidebar</h1>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item">FAQ Right Sidebar</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
            ...
            <div id="faq-page" class="innerpage-section-padding">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-8 content-side">
                            <div class="faq-block">
                                <h3 class="faq-heading">Choosing the Tour</h3>
                                <div class="card">
                                    <div class="card-header">
                                        <a data-bs-toggle="collapse" href="#collapse1"><h4 class="card-title">How can i choose multiple tours ?</h4></a>
                                    </div><!-- end card-header -->
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <a data-bs-toggle="collapse" href="#collapse2"><h4 class="card-title">Are there any extra fees that i have to pay ?</h4></a>
                                    </div><!-- end card-header -->
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <a data-bs-toggle="collapse" href="#collapse3"><h4 class="card-title">What are the safties related to tours ?</h4></a>
                                    </div><!-- end card-header -->
                            ...
                            <div class="faq-block">
                                <h3 class="faq-heading">Making Reservation</h3>
                                <div class="card">
                                    <div class="card-header">
                                        <a data-bs-toggle="collapse" href="#collapse4"><h4 class="card-title">What is your refund policy ?</h4></a>
                                    </div><!-- end card-header -->
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <a data-bs-toggle="collapse" href="#collapse5"><h4 class="card-title">Do you offer money back guarantee ?</h4></a>
                                    </div><!-- end card-header -->
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <a data-bs-toggle="collapse" href="#collapse6"><h4 class="card-title">What are the restrictions related to payment ?</h4></a>
                                    </div><!-- end card-header -->
                        ...
                        <div class="col-md-12 col-lg-4 side-bar right-side-bar">
                            <div class="side-bar-block booking-form-block text-center">
                                ...
                                <div class="booking-form">
                                    ...
                                    <form>
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Subject" required/></div>
                                        
                                        <div class="form-group">
                                            <textarea class="form-control" rows="5" placeholder="Your Question"></textarea>                                       
                                        </div>
                                        
                                        <button class="btn btn-block btn-orange w-100">Send Message</button>
                                    </form>
