            ...
            <div id="main-menu">
                ...
                <div class="list-group panel">
                            ...
                            <div class="collapse sub-menu" id="pages-links">
                                ...
                                <a class="items-list active" href="cards.html">Cards</a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-2 col-lg-2 dashboard-nav">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li class="nav-item active"><a class="nav-link" href="#"><span><i class="fa fa-credit-card"></i></span>My Cards</a></li>
                                    </ul>
                                </div><!-- end columns -->
                                
                                <div class="col-12 col-md-10 col-lg-10 dashboard-content my-cards">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-lg-6">
                                            <div class="card-block">
                                                ...
                                                <ul class="list-unstyled list-inline">
                                                    <li class="list-inline-item"><img src="images/master-card.png" class="img-fluid" alt="card-img" /></li>
                                                    <li class="list-inline-item fa-icons"><button class="btn" data-bs-toggle="modal" data-bs-target="#edit-card" ><span><i class="fa fa-pencil"></i></span></button><button class="btn"><span><i class="fa fa-close"></i></span></button></li>
                                                </ul>
                                            </div><!-- end card-block -->
                                        </div><!-- end columns -->
