                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md">
                                            <ul class="list-unstyled">
                                                ...
                                                <li class="active"><a href="before-you-fly.html">Before Fly</a></li>
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu" id="pages-links">
                                    ...
                                    <a class="items-list active" href="before-you-fly.html">Before Fly</a>
                ...
                <div class="row">
                    <div class="col-md">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Before You Fly</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
                        ...
                        <div class="col-12 col-lg-9 content-side byf-info">
                            <div class="space-right">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item">
                                        <a href="#airport-info" class="nav-link active" data-bs-toggle="tab"><span><i class="fa fa-building"></i></span>Airport Info</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#visa-passport" class="nav-link" data-bs-toggle="tab"><span><i class="fa fa-ticket"></i></span>Visa & Passport</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#check-in" class="nav-link" data-bs-toggle="tab"><span><i class="fa fa-check"></i></span>Check In</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#baggage-info" class="nav-link" data-bs-toggle="tab"><span><i class="fa fa-suitcase"></i></span>Baggage Information</a>
                                    </li>
                                </ul>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="airport-info" class="tab-pane active">
                                        <div class="byf-info-wrap">
                                            <img src="images/byf-airport-info.jpg" class="img-fluid" alt="byf-info-img">
                                    ...
                                    <div id="visa-passport" class="tab-pane">
                                        <div class="byf-info-wrap">
                                            <img src="images/byf-visa-passport.jpg" class="img-fluid" alt="byf-info-img">
                                    ...
                                    <div id="check-in" class="tab-pane">
                                        <div class="byf-info-wrap">
                                            <img src="images/byf-check-in.jpg" class="img-fluid" alt="byf-info-img">
                                    ...
                                    <div id="baggage-info" class="tab-pane">                                    
                                        <div class="byf-info-wrap">
                                            <img src="images/byf-baggage-info.jpg" class="img-fluid" alt="byf-info-img">
                                    ...
                                    <div class="side-bar-block recent-post">
                                        ...
                                        <div class="recent-block">
                                            <div class="recent-img">
                                                <a href="blog-detail-left-sidebar.html"><img src="images/holiday-deal-1.jpg" class="img-fluid" alt="holiday-deal-image" /></a>
                                            </div><!-- end recent-img -->
                                        ...
                                        <div class="recent-block">
                                            <div class="recent-img">
                                                <a href="blog-detail-left-sidebar.html"><img src="images/holiday-deal-2.jpg" class="img-fluid" alt="holiday-deal-image" /></a>
                                            </div><!-- end recent-img -->
                                        ...
                                        <div class="recent-block">
                                            <div class="recent-img">
                                                <a href="blog-detail-left-sidebar.html"><img src="images/holiday-deal-3.jpg" class="img-fluid" alt="holiday-deal-image" /></a>
                                            </div><!-- end recent-img -->
