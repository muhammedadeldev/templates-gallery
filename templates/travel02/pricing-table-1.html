    ...
    <div class="wrapper">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md">
                                            <ul class="list-unstyled">
                                                ...
                                                <li class="active"><a href="pricing-table-1.html">Pricing Table 1</a></li>
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu" id="pages-links">
                                    ...
                                    <a class="items-list active" href="pricing-table-1.html">Pricing Table 1</a> 
        ...
        <section class="page-cover" id="cover-price-table">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-title">Pricing Table 1</h1>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item">Pricing Table 1</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
